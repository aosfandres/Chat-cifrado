            ...
            try 
            {
                while ((stream = reader.readLine()) != null) 
                {
                     ...
                     if (data[2].equals(chat)) 
                     {
                        ...
                        if (crypt.desencriptar( data[1]).equals(""))
                            if (data[1].equals("has connected.")||data[1].equals("Disconnected."))
                                ta_chat.append(data[0] + ": " +data[1] + "\n");
                            else
                                ta_chat.append(data[0]+": "+"\t[Encrypted message] You must have the key.\n");
                        else
